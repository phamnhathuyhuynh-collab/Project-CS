...
closeTaskFormBtn.addEventListener("click", () =>{
    ...
    const formInputValuesUpdated = titleInput.value !== currentTask.Input || dateInput.value !== currentTask.date ||  descriptionInput.value !== currentTask.description;
...
cancelBtn.addEventListener("click", () =>{confirmCloseDialog.closest()});
